...
static const Rule rules[] = {
	...
	{ "st",       NULL,  "Terminal Emulator",            0,                0,               -1 },
};
...
<<<<<<< HEAD
	{ MODKEY|ShiftMask,		          XK_a,	                spawn,	       SHCMD("screen_cap") },
...
=======
	...
	{ MODKEY,                 XF86XK_AudioMute,		spawn,	       SHCMD("amixer sset Capture toggle &>/dev/null; kill -49 $(pidof dwmblocks)") },
	{ MODKEY,               XF86XK_AudioRaiseVolume,	spawn,	       SHCMD("mic_vol up &>/dev/null; kill -49 $(pidof dwmblocks)") },
>>>>>>> af74ad11224bdf4161cd6da3a7ef64f1c602ff47
	{ MODKEY,             XF86XK_AudioLowerVolume,	        spawn,	       SHCMD("mic_vol d &>/dev/null; kill -49 $(pidof dwmblocks)") },
	{ MODKEY,                       XK_p,                   spawn,              {.v = dmenucmd } },
	{ MODKEY|ShiftMask,             XK_Return,              spawn,              {.v = termcmd } },
	{ MODKEY|ShiftMask,             XK_r,                   spawn,              {.v = web     } },
	{ MODKEY,                       XK_Right,               goto_used,             {.i = 1} },
	{ MODKEY,                       XK_Left,                goto_used,             {.i =-1} },
	{ MODKEY,                       XK_x,                   first_unused,          {.i = 1} },
	{ MODKEY|ShiftMask,             XK_x,                   first_unused,          {.i =-1} },
	{ MODKEY,                       XK_s,                   findit,                {.v = &matches[0]} },
	{ MODKEY|ShiftMask,             XK_d,                   findit,                {.v = &matches[1]} },
	{ MODKEY,                       XK_l,                   findit,                {.v = &matches[2]} },
